    ...
    messages: [
      {
        ...
        content: `Vamos a parsear frases. La respuesta debe de ser un JSON valido con las siguientes propiedades:
          temporal_text: la parte de la frase que se refiere al tiempo, es decir, la indicacion temporal de la frase
          ...
          respuesta: { "temporal_text": "mañana a las 10", "temp_en": "tomorrow at 10 a.m.", "rest": "tengo dentista" }
          frase: "ayer cene con mi amigo por la noche"
          respuesta: { "temporal_text": "ayer por la noche", "temp_en": "last night", "rest": "cene con mi amigo" }
          frase: "1 en un minuto"
          respuesta: { "temporal_text": "en un minuto", "temp_en": "in a minute", "rest": "1" }
          frase: "${text}"
          respuesta:`,
      },
    ],
